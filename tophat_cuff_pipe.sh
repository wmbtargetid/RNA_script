...
# docker run
#docker run --rm -dit -v ../${input_dir}:/data --name pipe_1 genomicpariscentre/tophat2:latest /bin/bash
#docker run --rm -dit -v ../${input_dir}:/data --name pipe_2 fomightez/rnaseqcufflinks:latest /bin/bash
